...
const CLIENT_ID = 'GGZE4HmwTlGyBqcT4Z53Hg';
const CLIENT_SECRET = 'MPhhfumQ7Qj3adNXgbbx59UuoYWX11cx';
...
app.get('/api/v1/auth/zoom', (req, res) => {
    const authUrl = 'https://zoom.us/oauth/authorize?response_type=code&client_id=GGZE4HmwTlGyBqcT4Z53Hg&redirect_uri=https%3A%2F%2Fed09-183-82-122-12.ngrok-free.app%2F'
